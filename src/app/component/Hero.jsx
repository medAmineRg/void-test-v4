...
export const Hero = () => {
  return (
    <div className="relative h-[500px] w-full">
      ...
      <div className="p-4 bg-white rounded-md w-[80%] z-10 absolute -bottom-0.5 left-1/2 top-1/2 transform -translate-x-1/2 lg:w-[40%] h-max lg:left-[350px] lg:-translate-x-1/2 lg:-translate-y-1/2 lg:py-8">
        <h1 className="font-bold text-2xl lg:text-4xl lg:leading-[3rem]">
          {`Journée des maladies rares 2024 : L'équité en action`}
        </h1>
        <p className="my-3 text-xs lg:text-base text-gray-600 lg:my-4 ">
